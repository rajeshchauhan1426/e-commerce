...
export const ProductForm: React.FC<ProductFormProps> = ({ initialData, categories, colors, sizes }) => {
  ...
  const form = useForm<ProductFormValues>({
    ...
    defaultValues: initialData  ? {
      ...
      images: initialData.images, // Ensure images are part of initial data
  ...
  const onSubmit = async (data: ProductFormValues) => {
    ...
    try {
      ...
      const productData = {
        ...
        storeId: storeId // Include storeId in the productData - important for relating to the correct store
      };
